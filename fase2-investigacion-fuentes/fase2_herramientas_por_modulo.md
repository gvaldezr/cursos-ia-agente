...
> **Herramienta principal recomendada:** Amazon Quick (antes Amazon Q)

---

## Tabla de Precios Rápida — Referencia General

| Herramienta | Plan Gratuito | Plan Individual | Plan Equipos/Edu | Fuente |
|---|---|---|---|---|
| **Amazon Quick** | Sí (Free) | Plus $20/mes | Pro $20/usuario/mes (AWS) | [aws.amazon.com/quick/pricing](https://aws.amazon.com/quick/pricing/) |
| **ChatGPT** | Sí (limitado) | Plus $20/mes | Team $25/usuario/mes; Edu bajo cotización | [chatgpt.com/pricing](https://chatgpt.com/pricing/) |
| **Google Gemini** | Sí (con cuenta Google) | Advanced $20/mes | Edu: gratuito base; AI Pro $20/usuario/mes | [edu.google.com](https://edu.google.com/workspace-for-education/add-ons/gemini-education/) |
| **Claude (Anthropic)** | Sí (limitado) | Pro $20/mes | Team $25/usuario/mes | [claude.com/pricing](https://claude.com/pricing) |
| **Microsoft Copilot** | Sí (Copilot Chat) | Pro $20/mes | Educación $18/usuario/mes | [microsoft.com/education](https://www.microsoft.com/en-us/education/products/copilot-in-education) |
| **Notion AI** | Trial limitado | Business $20/usuario/mes (AI incluido) | Enterprise: cotización | [notion.com/pricing](https://www.notion.com/pricing) |
| **Gamma** | Sí (400 créditos) | Plus $9/mes | Pro $18/mes | [gamma.app/pricing](https://gamma.app/pricing) |
...
- **Costo:** Free (limitado) / Plus $20/mes
- **Caso de uso:** Demostración interactiva de conceptos. Los participantes pueden experimentar con generación de texto, análisis de imágenes, y razonamiento paso a paso. La interfaz más conocida del mercado, ideal para primeras experiencias.

### Alternativa 2: Google Gemini (Free)
...
### Alternativa 1: ChatGPT (Free/Plus)
- **URL:** [chatgpt.com](https://chatgpt.com)
- **Costo:** Free / Plus $20/mes
- **Caso de uso:** Ejercicios prácticos de frameworks de prompt. La función de "Custom GPTs" permite crear asistentes especializados con instrucciones predefinidas — análogo a los frameworks como plantillas reutilizables. Interfaz conversacional intuitiva para iteración rápida.

### Alternativa 2: Claude (Free/Pro)
...
- **URL:** [microsoft.com/copilot](https://www.microsoft.com/en-us/education/products/copilot-in-education)
- **Costo:** Copilot Chat gratuito; M365 Copilot Edu $18/usuario/mes
- **Caso de uso:** Redacción directa dentro de Outlook y Word. Si la universidad ya usa Microsoft 365, Copilot ofrece la experiencia más integrada: genera borradores de email, resume hilos de conversación, y ajusta tono desde la misma interfaz de Outlook. Incluye función "Teach" para educación.

### Alternativa 2: Google Gemini en Workspace
- **URL:** [edu.google.com/gemini](https://edu.google.com/workspace-for-education/add-ons/gemini-education/)
...
- **URL:** [chatgpt.com](https://chatgpt.com)
- **Costo:** Plus $20/mes (incluye Advanced Data Analysis)
- **Caso de uso:** Subir PDFs, hojas de cálculo y reportes. La función de análisis avanzado de datos genera gráficos, tablas comparativas, y estadísticas automáticamente. Puede procesar archivos de hasta 512MB. Ideal para análisis rápido de reportes financieros o de matrícula.

### Alternativa 2: Google NotebookLM (Gratuito)
...
- **Costo:** Business $20/usuario/mes anual (AI incluido con agentes)
- **Caso de uso:** Bases de datos con vistas automáticas, templates de reportes que se actualizan con fórmulas y rollups. Los Custom Agents de Notion (desde febrero 2026) pueden ejecutarse en schedules y triggers, conectándose con Slack y otras herramientas. Ideal para equipos que ya usan Notion como hub de información.

### Alternativa 2: Microsoft Copilot + Power Automate
- **URL:** [microsoft.com/copilot](https://www.microsoft.com/en-us/microsoft-365-copilot/pricing)
...
- **Costo:** Team $25/usuario/mes; Edu bajo cotización institucional
- **Caso de uso:** Custom GPTs como "asistentes virtuales" para departamentos específicos. Se pueden crear GPTs de Admisiones, Servicios Escolares, Becas, etc. con instrucciones y documentos específicos. ASU (Arizona State) ha activado más de 250 proyectos con ChatGPT Edu incluyendo asistentes de financial aid y soporte estudiantil (ASU Tech, 2024-2025).

### Alternativa 2: Google Gemini + Workspace Studio
- **URL:** [edu.google.com](https://edu.google.com/intl/ALL_us/resources/institution-type/higher-ed-solutions/)
...
### Alternativa 1: Notion AI (Business $20/usuario/mes)
- **URL:** [notion.com](https://www.notion.com/pricing)
- **Costo:** Business $20/usuario/mes anual (AI incluido)
- **Caso de uso:** Gestión de proyectos completa: Kanban, timelines, bases de datos relacionales, todo potenciado con IA. Notion AI puede generar resúmenes de proyectos, identificar bloqueos, y sugerir próximos pasos. Los AI Agents automatizan updates de estatus y notificaciones.
- **Ventaja:** La plataforma de gestión de proyectos más completa con IA integrada nativamente.

### Alternativa 2: ChatGPT (Plus/Team)
- **URL:** [chatgpt.com](https://chatgpt.com)
...
- **Caso de uso del nivel:** El nivel más avanzado y donde Amazon Quick es más diferenciado:
  ...
  - **Conexión con herramientas externas** (Slack, M365, Google, QuickBooks)
  - Los participantes diseñan un flujo completo: agente de análisis → agente de redacción → distribución automática
- **Caso Enterprise:** Dashboards de Quick Sight + agentes + automatización = operación inteligente completa. Incluye RBAC, SSO, soberanía de datos, y controles admin.

### Alternativa 1: ChatGPT Enterprise/Edu + Workspace
- **URL:** [chatgpt.com/pricing](https://chatgpt.com/pricing/)
- **Costo:** Enterprise ~$45-75/usuario/mes (cotización); Edu bajo cotización
- **Caso de uso:** Workspace Agents (agentes compartidos a nivel organización), ChatGPT Work para flujos conectados con datos empresariales, y Codex para automatización. Modelo de créditos flexibles. ASU y más de 200 universidades ya lo despliegan a escala.

### Alternativa 2: Notion AI + Integraciones
- **URL:** [notion.com](https://www.notion.com/pricing)
...
| 3. Email y Comunicados | Amazon Quick | Copilot (si M365) / Gemini (si Google) | Plus $20/mes |
| 4. Análisis de Reportes | Amazon Quick | NotebookLM (gratis) | Plus $20/mes |
| 5. Automatización Reportes | Amazon Quick | Notion AI | Plus $20/mes |
| 6. Atención Alumnos | Amazon Quick | ChatGPT Edu / Gemini Edu | Plus $20/mes |
| 7. Gestión Proyectos | Notion AI | Amazon Quick | Business $20/usuario |
| 8. Flujos y Agentes | Amazon Quick Pro | ChatGPT Enterprise | Pro $20/usuario AWS |

---

## 💡 Recomendación de Stack para el Curso

**Stack mínimo (costo $0):**
- Amazon Quick Free + ChatGPT Free + Google Gemini Free + NotebookLM

**Stack recomendado (~$20/mes por participante):**
- Amazon Quick Plus ($20/mes) + ChatGPT Free + Gemini for Education (gratuito institucional)

**Stack completo para implementación institucional:**
- Amazon Quick Pro ($20/usuario/mes AWS) + Microsoft Copilot Edu ($18/usuario/mes) + Notion Business ($20/usuario/mes)

---

> **Fuentes verificadas:** Todas las URLs fueron consultadas y verificadas en septiembre 2026. Los precios corresponden a las páginas oficiales de cada proveedor consultadas en esa fecha. Los precios pueden variar; consultar siempre la página oficial antes de tomar decisiones de compra.
