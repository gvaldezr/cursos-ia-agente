...
<div style="background-color: #f5f0fa; padding: 20px; border-radius: 8px;
  ...
  <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
    <span><strong>Niveles completados:</strong></span>
  ...
  <div style="display: flex; justify-content: space-between; margin-top: 12px;
    ...
    <span>🔵 Estratega IA {{BADGE_2_STATUS}}</span>
...
### Semana 1 — Nivel 1: «El lunes a las 8 AM»
...
| **TIP_SEMANAL** | **Pruebe la «regla de los 2 minutos» esta semana:** cada vez que tenga que redactar algo (correo, comunicado, nota), antes de escribir, dedique 2 minutos a pedírselo a Amazon Quick con una instrucción clara. No necesita un prompt perfecto todavía — eso lo aprenderá en el Nivel 2. Solo practique el hábito de *preguntar antes de escribir*. En una semana, va a notar la diferencia. |
| **PREVIEW_SIGUIENTE** | En el **Nivel 2: «Las tres recetas»** va a aprender los frameworks que convierten instrucciones vagas en resultados consistentes. Va a entender POR QUÉ su primer prompt funcionó bien (o no tan bien) y va a crear 3 prompts maestros que le servirán todos los días. |
| **CTA_TEXTO** | CONTINUAR CON EL NIVEL 2 |

---

### Semana 2 — Nivel 2: «Las tres recetas»
...
| **TIP_SEMANAL** | **Guarde sus mejores prompts en un documento.** Abra un archivo de texto o nota y empiece a copiar ahí cada prompt que le dé un buen resultado. No tiene que ser perfecto ni organizado todavía (eso lo haremos en el Nivel 8). Solo empiece el hábito. En unas semanas, tendrá un banco de instrucciones que vale su peso en oro. |
| **PREVIEW_SIGUIENTE** | Ahora que tiene las recetas, va a usarlas para atacar su dolor más grande: las **horas diarias escribiendo correos y comunicados**. El **Nivel 3: «Nunca más la pantalla en blanco»** le va a dar 5 templates de comunicación institucional listos para usar — uno para cada tipo de mensaje que envía recurrentemente. |
| **CTA_TEXTO** | IR AL NIVEL 3 |

---

### Semana 3 — Nivel 3: «Nunca más la pantalla en blanco»
...
| **PREVIEW_SIGUIENTE** | Ya domina la comunicación con IA. Pero su bandeja no solo tiene correos — tiene **reportes**. Documentos de 50 páginas que lee a medias porque no tiene tiempo. El **Nivel 4: «Las 50 páginas que nadie lee»** va a cambiar eso: va a convertir un reporte real de su área en un resumen ejecutivo de 1 página. |
| **CTA_TEXTO** | AVANZAR AL NIVEL 4 |

**Nota especial Semana 3:** Si el participante completó los niveles 1-3, incluir:

```html
<div style="background-color: #e8f5e9; padding: 16px; border-radius: 8px;
            text-align: center; margin: 16px 0;">
  🟢 <strong>¡Felicidades!</strong> Ha desbloqueado el badge
  <strong>«Explorador IA»</strong>.<br>
...
### Semana 4 — Nivel 4: «Las 50 páginas que nadie lee»
...
| **PREVIEW_SIGUIENTE** | Acaba de convertir un reporte de 50 páginas en un resumen de 1 página. Pero lo hizo manualmente. ¿Y si pudiera **automatizar** ese proceso para que su reporte mensual se genere en 15 minutos? El **Nivel 5: «El dato que la IA inventó»** le enseña cómo — y también le enseña por qué la verificación no es opcional. |
| **CTA_TEXTO** | CONTINUAR AL NIVEL 5 |

---

### Semana 5 — Nivel 5: «El dato que la IA inventó»
...
| **PREVIEW_SIGUIENTE** | Ya sabe automatizar Y verificar. Ahora viene una dimensión que aún no ha tocado: la IA interactuando con **personas**. Alumnos, padres, proveedores, colaboradores. ¿Hasta dónde es ético que la IA responda por usted? El **Nivel 6: «La línea que no se cruza»** le da las herramientas para decidir. |
| **CTA_TEXTO** | IR AL NIVEL 6 |

---

### Semana 6 — Nivel 6: «La línea que no se cruza»
...
| **CTA_TEXTO** | AVANZAR AL NIVEL 7 |

**Nota especial Semana 6:** Si el participante completó los niveles 4-6, incluir:

```html
<div style="background-color: #e3f2fd; padding: 16px; border-radius: 8px;
            text-align: center; margin: 16px 0;">
  🔵 <strong>¡Segundo badge desbloqueado!</strong> Ha obtenido
  <strong>«Estratega IA»</strong>.<br>
  Ya cuenta con 2 de 3 badges. Un nivel más y completa la trilogía.
</div>
```

---

### Semana 7 — Nivel 7: «De la junta al tablero en 15 minutos»
...
| **PREVIEW_SIGUIENTE** | No hay nivel siguiente. Pero hay un paso muy importante: en los próximos días recibirá un email con su **encuesta de satisfacción**, los detalles sobre la **emisión de sus badges**, y una invitación especial. Esté pendiente. |
...
| **Trigger** | No ha completado un nivel en 14+ días |
...
**Donde lo dejó:**
- Último nivel completado: {{ULTIMO_MODULO}}
- Siguiente nivel: {{SIGUIENTE_MODULO}} — «{{TITULO_SIGUIENTE}}»
- Tiempo estimado para completarlo: 25-35 minutos

**¿Qué le está frenando?**

Si es **tiempo:** el siguiente nivel toma solo 30 minutos. Puede
...
2. **Segmentación por velocidad:** Si un participante va adelantado (completó 2 niveles en 1 semana), ajustar el email para reflejar su progreso real, no el calendario estándar.
3. **Re-engagement:** Activar la variante de re-engagement automáticamente cuando el participante no completa un nivel en 14 días. Máximo 2 re-engagements durante el programa.
